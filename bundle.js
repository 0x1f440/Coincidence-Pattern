...
dat.controllers.BooleanController=function(e,a,c){var d=function(c,b){d.superclass.call(this,c,b);var e=this;this.__prev=this.getValue();this.__checkbox=document.createElement("input");this.__lb=document.createElement("label");this.__checkbox.setAttribute("type","checkbox");a.bind(this.__checkbox,"change",function(){e.setValue(!e.__prev)},false);this.domElement.appendChild(this.__checkbox);this.domElement.appendChild(this.__lb);this.updateDisplay()};d.superclass=e;c.extend(d.prototype,e.prototype,{setValue:function(a){a=d.superclass.prototype.setValue.call(this,a);this.__onFinishChange&&
...
function(a){a.domElement.style.zIndex=A?-999:999;a.domElement.style.opacity=A?0:1})};k.CLASS_AUTO_PLACE="a";k.CLASS_AUTO_PLACE_CONTAINER="ac";k.CLASS_MAIN="main";k.CLASS_CONTROLLER_ROW="cr";k.CLASS_TOO_TALL="taller-than-window";k.CLASS_CLOSED="closed";k.CLASS_CLOSE_BUTTON="close-button";k.CLASS_DRAG="drag";k.DEFAULT_WIDTH=110;k.TEXT_CLOSED="Close Controls";k.TEXT_OPEN="Controls";g.bind(window,"keydown",function(a){document.activeElement.type!=="text"&&(a.which===72||a.keyCode==72)&&k.toggleHide()},
...
".dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0px;left:0;right:12px;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity 0.1s linear;-o-transition:opacity 0.1s linear;-moz-transition:opacity 0.1s linear;transition:opacity 0.1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity 0.1s linear;-o-transition:opacity 0.1s linear;-moz-transition:opacity 0.1s linear;transition:opacity 0.1s linear;border:0;position:absolute;line-height:19px;height:20px;cursor:pointer;text-align:right;}.dg.main .close-button:hover{}.dg.a{float:right;overflow-x:hidden}.dg.a.has-save ul{margin-top:27px}.dg.a.has-save ul.closed{margin-top:0}.dg.a .save-row{position:fixed;top:0;z-index:1002}.dg li{-webkit-transition:height 0.1s ease-out;-o-transition:height 0.1s ease-out;-moz-transition:height 0.1s ease-out;transition:height 0.1s ease-out}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;overflow:hidden;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li > *{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px}.dg .property-name{cursor:default;float:left;clear:left;overflow:hidden;text-overflow:ellipsis}.dg .c{float:left;width:60%}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:9px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{font:11px 'Lucida Grande', sans-serif;}.dg.main::-webkit-scrollbar{width:5px;}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){;border-bottom:}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2fa1d6}.dg .cr.number input[type=text]{color:#2fa1d6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#9cef97}.dg .cr.function:hover,.dg .cr.boolean:hover{background: #666}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2fa1d6}.dg .c .slider:hover{color:#62ef58}.dg .c .slider:hover .slider-fg{}\n",
dat.controllers.factory=function(e,a,c,d,f,b,n){return function(h,j,m,l){var o=h[j];if(n.isArray(m)||n.isObject(m))return new e(h,j,m);if(n.isNumber(o))return n.isNumber(m)&&n.isNumber(l)?new c(h,j,m,l):new a(h,j,{min:m,max:l});if(n.isString(o))return new d(h,j);if(n.isFunction(o))return new f(h,j,"");if(n.isBoolean
  (o))return new b(h,j)}}(dat.controllers.OptionController,dat.controllers.NumberControllerBox,dat.controllers.NumberControllerSlider,dat.controllers.StringController=function(e,a,c){var d=
...
"mouseup",j)}function j(){a.unbind(window,"mousemove",q);a.unbind(window,"mouseup",j)}function g(){var a=d(this.value);a!==false?(p.
  __color.__state=a,p.setValue(p.__color.toOriginal())):this.value=p.__color.toString()}function i(){a.unbind(window,"mousemove",s);a.unbind(window,"mouseup",i)}function q(b){b.preventDefault();var c=a.getWidth(p.__saturation_field),d=a.getOffset(p.__saturation_field),e=(b.clientX-d.left+document.body.scrollLeft)/c,b=1-(b.clientY-d.top+document.body.scrollTop)/c;b>1?b=
...
document.createElement("div");a.extend(this.domElement.style,{position:"fixed",display:"none",zIndex:"1001",opacity:0,WebkitTransition:"-webkit-transform 0.2s ease-out, opacity 0.2s linear"});document.body.appendChild(this.backgroundElement);document.body.appendChild(this.domElement);var c=this;e.bind(this.backgroundElement,"click",function(){c.hide()})};c.prototype.show=function(){var c=this;this.backgroundElement.style.display="block";this.domElement.style.display="block";
this.domElement.style.opacity=0;this.domElement.style.webkitTransform="scale(1.1)";this.layout();a.defer(function(){c.backgroundElement.style.opacity=1;c.domElement.style.opacity=1;c.domElement.style.webkitTransform="scale(1)"})};c.prototype.hide=function(){vara=this,c=function(){a.domElement.style.display="none";a.backgroundElement.style.display="none";e.unbind(a.domElement,"webkitTransitionEnd",c);e.unbind(a.domElement,"transitionend",c);e.unbind(a.domElement,"oTransitionEnd",c)};e.bind(this.domElement,"webkitTransitionEnd",c);e.bind(this.domElement,"transitionend",c);
...
return c }(dat.dom.dom,dat.utils.common),dat.dom.dom,dat.utils.common);



// "}Added for Browserify
module.exports = dat;
...
//----------------------------------------------------------------------------------------------------
var countUpArrow = document.getElementsByClassName("count-up");
...
function checkCounterIsFilled() {
  for(i=0; i<6; i++){
      if(!document.getElementById("counter" + i).value){
        if(isFilled){
          radii = [
              10
            , 10
...
var countUp = function() {
    var index = this.nextSibling.nextSibling.id.toString()[7];

    if(!this.nextSibling.nextSibling.value){
      this.nextSibling.nextSibling.value = 0;
    }

    this.nextSibling.nextSibling.value = (parseInt(this.nextSibling.nextSibling.value) + 1) % 10;
    numbers[index] = this.nextSibling.nextSibling.value;

    checkCounterIsFilled();
    if(isFilled){
      makePattern();
    }
};
...
var countDown = function() {
  var index = this.previousSibling.previousSibling.id.toString()[7];

  if(!this.previousSibling.previousSibling.value){
    this.previousSibling.previousSibling.value = 0;
  }

  this.previousSibling.previousSibling.value = (parseInt(this.previousSibling.previousSibling.value) + 10 - 1) % 10;
  numbers[index] = this.previousSibling.previousSibling.value;
...
for (var i = 0; i < countUpArrow.length; i++) {
    countUpArrow[i].addEventListener('click', countUp, false);
}

for (var i = 0; i < countDownArrow.length; i++) {
    countDownArrow[i].addEventListener('click', countDown, false);
}
...
for (var i = 0; i < 6; i++){
  ...
  document.getElementsByClassName('edit-items')[i].addEventListener('keydown', function(e) {
    inputIndex = parseInt(this.id.toString()[7]);
    temp = this.value;

    switch (e.keyCode) {
      case 37: //left
        document.getElementById("counter"+(inputIndex + 6 - 1) % 6).focus();
        break;
      case 39:
        document.getElementById("counter"+(inputIndex + 1) % 6).focus();
        break;
      case 38:
...
document.getElementsByClassName('edit-items')[i].addEventListener('keyup', function(e) {

    if ( (48 <= e.keyCode && e.keyCode <= 57) ||( 96 <= e.keyCode && e.keyCode <= 105) || e.keyCode == 38 || e.keyCode == 40 ){
...
function makePattern(){
  ...
  for(i=0; i<4; i++){
      radii[i] = parseInt(hash.slice(i*2, (i*2)+2), 16) % 190 + 10;
      //console.log(radii[i]);
  }
...
gui.add(options, 'Dark')
gui.add(options, 'Numbers')
    ...
    fetch(imgURL).then(function(response) {
        ...
        document.getElementById("random").addEventListener("click", function(){
          ...
          for(i=0; i<6; i++){
            ...
            document.getElementById("counter"+i).value = numbers[i];
          }
          makePattern();
          draw();
        });
...
function updateSliders(sliderCount) {
  ...
  radii.length = sliderCount
  draw()
}

updateSliders(sliderCount)

function setFontColor(hex){
  var items = document.getElementsByClassName("edit-items");
  var arrows = document.getElementsByClassName("counters");

  for(i=0; i<items.length; i++){
    document.getElementsByClassName("edit-items")[i].style.color = hex;
  }
  for(i=0; i<arrows.length; i++){
    document.getElementsByClassName("counters")[i].style.color = hex;
  }
}
...
raf(canvas).on('data', function() {
  ...
  for (var i = 0, l = radii.length; i < l; i += 1) {
    radii[i] += Math.sin((now - i * 5000) * 0.0001 * Math.sin(i / 1.3)) * 0.0005
    options.Size += Math.sin((now + 5000) * 0.00008) * 0.005
  }
